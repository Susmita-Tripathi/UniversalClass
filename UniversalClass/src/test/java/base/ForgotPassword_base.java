...
public class ForgotPassword_base {
	...
	public void before_scenario()
	{
		...
		try {
			prop = new Properties();
			prop.load(new FileInputStream("src/test/resources/forgotPass.properties"));
		}catch (Exception e) {}
		
		htmlreport = new ExtentHtmlReporter(prop.getProperty("reportslocations")+"\\snapdeal.html");
