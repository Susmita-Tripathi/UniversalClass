...
public class SignIn_base
{
	...
	public void before_scenario()
	{
		...
		htmlreport = new ExtentHtmlReporter(prop.getProperty("reportslocation")+"\\UniversalClass.html");
		 ext = new ExtentReports();
		 ext.attachReporter(htmlreport);
		 ext.setSystemInfo("Host Name", "Mysystem");
		 ext.setSystemInfo("Environment", "Test Env");
		 ext.setSystemInfo("User Name", "Amruta Kolekar");
		   
		 htmlreport.config().setDocumentTitle("UniversalClass");
		 htmlreport.config().setReportName("UniversalClass SignIn Functional Testing");
